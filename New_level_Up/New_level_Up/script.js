...
function showPlayerCard() {
    ...
    // Update download button - ALL RANKS CAN NOW DOWNLOAD
    downloadCardBtn.disabled = false;
    downloadCardBtn.innerHTML = '<i class="fas fa-download"></i> DOWNLOAD CARD';
    
    // Show modal
    cardModal.classList.add('active');
    
    // Add system message
    addSystemMessage("[PLAYER CARD]", "Player card displayed. All ranks can now download their card!");
}

// Download player card as image - MODIFIED: ALL RANKS CAN DOWNLOAD
function downloadPlayerCard() {
    ...
    // REMOVED RANK RESTRICTION - NOW ALL RANKS CAN DOWNLOAD
